...
const BentoTilt = ({children, className=''}) => {
    ...
    const handleMouseMove = (e) => {
        ...
        setTransformStyle(`perspective(1000px) rotateX(${tiltY}deg) rotateY(${tiltX}deg) scale3d(0.95, 0.95, 0.95)`)
    }
    ...
    return (
        <div className="relative size-full">
            <video 
                ...
                muted 
                autoPlay 
                className="absolute left-0 top-0 h-full size-full object-cover object-center"
            />
    ...
    <section className='bg-black pb-52'>
        <div className='container mx-auto px-3 md:px-10'>
            ...
            <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>
                Immerse yourself in a rich and ever expanding universe where a vibrant array of products converge Into
                interconnected overlay experience on your world.
            </p>
        </div>
        <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh] duration-300'>
            <BentoCard 
                src="videos/feature-1.mp4"
                title={<>radia<b>n</b>t</>}
                description="A cross-platform metagame app, turning your activities acrooss Web2 and Web3 into a rewarding adventure."
                />
        </BentoTilt>
